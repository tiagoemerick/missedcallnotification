...
public class ErrorTabActivity extends Activity {
	...
	private OnItemClickListener optionsLogListener = new OnItemClickListener() {
		...
		public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
			...
			AlertDialog.Builder builder = new AlertDialog.Builder(ErrorTabActivity.this);
			...
			items[2] = getApplicationContext().getString(R.string.list_option_tryagain);
			...
			builder.setItems(items, new DialogInterface.OnClickListener() {
				...
				private void doAction(MissedCallLog mclSelected, int numberSelectedOption) {
					...
					case 2:
						...
						Toast.makeText(getBaseContext(), "Tentando enviar novamente. Por favor, recarregue a lista", Toast.LENGTH_LONG).show();
						break;
					case 3:
	...
	private void loadListAdapter() {
		...
		List<MissedCallLog> logsToSendState = (List<MissedCallLog>) getMissedCallNotiDSLog().findAllErrorState();
	...
	private void createComponentsView() {
		listError = (ListView) findViewById(R.id.listToSend);
	}

	private void createComponentsListeners() {
		listError.setOnItemClickListener(optionsLogListener);
	}

	private ProgressDialog createProgressDialog() {
		final ProgressDialog dialog = ProgressDialog.show(ErrorTabActivity.this, getApplicationContext().getString(R.string.app_name), getApplicationContext().getString(R.string.loading_label), false, false);
